...
#define	MAX_MAP_LIGHTING		0x800000	// LordHavoc: raised from 0x100000 (1mb) to 0x400000 (4mb)
					// g-cont: up to 8 mb colored lightdata
...
#define BSPVERSION	30	// g-cont. changed to Half-Life bsp format
...
extern	byte		drgblightdata[MAX_MAP_LIGHTING];

// LordHavoc: stored in .dlit file
extern	int			nmaplightdatasize;
extern	byte		dnmaplightdata[MAX_MAP_LIGHTING];
