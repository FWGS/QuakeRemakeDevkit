...
int main (int argc, char **argv)
{
	...
	printf( "g-cont. special build for GoldSource and Xash Engine\n");
	printf( "\n" );
	...
	else if (!strcmp (argv[i], "-tohl"))
		return Bsp2HL_Main (argc-i, argv+i);
...
"-tohl       convert quake bsp into hl bsp\n"
"\n"
"What the options do:\n"
