...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /subsystem:windows /dll /debug /machine:I386 /def:".\progs.def"
# SUBTRACT LINK32 /profile /map
# Begin Custom Build
TargetDir=\Xash3D\id1\devkit\source_code\temp\dlls\!release
InputPath=\Xash3D\id1\devkit\source_code\temp\dlls\!release\progs.dll
SOURCE="$(InputPath)"

"D:\Xash3D\id1\cl_dlls\progs.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\progs.dll "D:\Xash3D\id1\cl_dlls\progs.dll"
...
# ADD CPP /nologo /G5 /MTd /W3 /Gm /ZI /Od /I "..\dlls" /I "..\engine" /I "..\common" /I "..\game_shared" /I "..\pm_shared" /I "..\\" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "QUIVER" /D "VOXEL" /D "QUAKE2" /D "VALVE_DLL" /D "CLIENT_WEAPONS" /FAs /FR /YX /FD /c
...
# Begin Custom Build
TargetDir=\Xash3D\id1\devkit\source_code\temp\dlls\!debug
InputPath=\Xash3D\id1\devkit\source_code\temp\dlls\!debug\progs.dll
SOURCE="$(InputPath)"
